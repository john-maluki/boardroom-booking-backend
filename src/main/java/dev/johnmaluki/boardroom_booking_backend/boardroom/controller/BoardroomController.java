...
public class BoardroomController {
  ...
  public ResponseEntity<ReservationOverlapResponseDto> checkReservationEventOverlap(
    ...
    return ResponseEntity.ok(
        boardroomService.checkBoardroomReservationOverlap(boardroomId, reservationEventDateDto));
  }
  ...
  public ResponseEntity<BoardroomResponseDto> getBoardroomById(
      @PathVariable("boardroomId") long boardroomId) {
  ...
  public ResponseEntity<UserResponseDto> getBoardroomAdministrator(
      @PathVariable("boardroomId") long boardroomId) {
  ...
  public ResponseEntity<List<BoardroomContactResponseDto>> getBoardroomContacts(
      @PathVariable("boardroomId") long boardroomId) {
  ...
  public ResponseEntity<BoardroomContactResponseDto> createBoardroomContact(
    ...
    return ResponseEntity.ok(
        boardroomService.createBoardroomContact(boardroomId, boardroomContactDto));
  }
  ...
  public ResponseEntity<Void> removeBoardroomContact(
      @PathVariable("boardroomId") long boardroomId, @PathVariable("contactId") long contactId) {
  ...
  public ResponseEntity<BoardroomContactResponseDto> updateBoardroomContact(
      ...
      @RequestBody @Valid BoardroomContactDto boardroomContactDto) {
    return ResponseEntity.ok(
        boardroomService.updateBoardroomContact(boardroomId, contactId, boardroomContactDto));
  }
  ...
  public ResponseEntity<List<BoardroomEventFilterResponseDto>> checkAvailableBoardroomByEventDate(
      @RequestBody @Valid ReservationEventDateDto reservationEventDateDto) {
    return ResponseEntity.ok(
        boardroomService.filterAvailableBoardroomsByEventDate(reservationEventDateDto));
  }
}
